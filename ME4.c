...
{	
	...
	mctx.vS = vS;
		...
		for(i=0;i<FL;i++){
			for(j=0;j<FL;j++){
				fprintf(stderr,"%lf  ",mctx.H0W[i][j]);
			}
			fprintf(stderr,"\n");
		}
		fprintf(stderr,"\n");
		...
		for(i=0;i<FL;i++){
			for(j=0;j<FL;j++){
				fprintf(stderr,"%lf  ",mctx.WH0W[i][j]);
			}
			fprintf(stderr,"\n");
		}
		fprintf(stderr,"\n");															
		...
		for(i=0;i<FL;i++){
			for(j=0;j<FL;j++){
				fprintf(stderr,"%lf  ",mctx.H0H0W[i][j]);
			}
			fprintf(stderr,"\n");
		}
		fprintf(stderr,"\n");	*/														
