...
dfile(f,a,b) = sprintf("b_%.3f_eigen_%d_E1.000e+0%d.dat", f, a, b)
ofile(f,a,b) = sprintf("exp_b_%.3f_eigen_%d_%d.pdf", f, a, b)
Efile(f,a,b) = sprintf("exp_b_%.3f_eigen_%d_%d.pdf", f, a , b)
