...
# ### L,N,C :: UpperLimit: 0.2/1.0 ; NumberOfPoints: 1–7 ; Column: 2–14 ; energy dependence;
varE(a,b,c) = sprintf("set xlabel \"%s\" ; set ylabel \"%s\"; plot for [i=1:7] dfile(%.3f, N[%d], E[i]) u 1:%d t sprintf(\"10^{%s}\", E[i])", "ξ", meow[c], a, b, c, "%d")
# ### L,E,C :: UpperLimit; 0.2/1.0 ; Energy: 1–7 ; Column: 2–14 ; umber of points dependence;
